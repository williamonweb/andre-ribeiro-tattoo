...
export function BlobImageInput({name,folder,label,help,maxBytes=12_000_000,className}:{name:string;folder:string;label:string;help:string;maxBytes?:number;className?:string}){
